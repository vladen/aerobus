...
(function (global, factory) {
  ...
  var Aerobus = (function () {
    function Aerobus(extentions, delimiter, trace, bus) {
    ...
    _createClass(Aerobus, [{
      ...
      value: function get(name) {
        ...
        if (!channel) {
          ...
          var extention = this[EXTENTIONS].get('Channel') || Extention;
          var extentionChannel = buildChannelClass(extention);
  ...
  function aerobus() {
    ...
    var context = new Aerobus(this[EXTENTIONS], delimiter, trace);
    ...
    function bus() {
      ...
      switch (channels.length) {
        ...
        default:
          var extention = context[EXTENTIONS].get('Section') || Extention;
          var extentionSection = buildSectionClass(extention);
          return new extentionSection(context, channels.map(function (channel) {
  ...
  function patchAerobus(href) {
    var self = href;
    var test = href.bind(self);

    test.extend = function (name, parameters) {
  ...
  function extend(name, parameters) {
    var extention = this[EXTENTIONS].get(name) || Extention;
