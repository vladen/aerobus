...
(function (global, factory) {
  ...
  var CHANNEL_HIERARCHY_DELIMITER = '.',
    ...
    return gear;
      ...
      hasGear = function hasGear(key) {
    return gears.has(key);
  },
      setGear = function setGear(key, gear) {
    isSomething(gear) ? gears.set(key, gear) : gears.delete(key, gear);
  },
      tryGetGear = function tryGetGear(key) {
    return gears.get(key);
  };
  ...
  var ChannelBase = (function () {
    ...
    _createClass(ChannelBase, [{
      ...
      value: function _delete() {
        var gear = tryGetGear(this);
        if (!gear) return;
        var channels = gear.bus.channels,
            name = gear.name;
  ...
  function aerobus() {
    ...
    return defineProperties(bus, (_defineProperties = {}, _defineProperty(_defineProperties, $CLASS, {
      ...
      get: getChannels
    }), _defineProperty(_defineProperties, 'delete', {
      value: deleteBus
      ...
      get: getError
    }), _defineProperty(_defineProperties, 'isDeleted', {
      get: getIsDeleted
