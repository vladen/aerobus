...
(function (global, factory) {
  ...
  var Aerobus = (function () {
    function Aerobus(channelCLass, sectionClass, delimiter, trace, bus) {
  ...
  function aerobus() {
    ...
    var sectionExtention = this[EXTENTIONS].get('Section') || noop;
    var channelClass = buildChannelClass(channelExtention);
    var sectionClass = buildSectionClass(sectionExtention);
    var context = new Aerobus(channelClass, sectionClass, delimiter, trace);
