...
(function (global, factory) {
  ...
  var Bus = (function () {
    ...
    _createClass(Bus, [{
      ...
      key: 'getMany',
      value: function getMany(names) {
        var _this = this;

        switch (names.length) {
          case 0:
            return this.getOne(CHANNEL_NAME_ROOT);
  ...
  var Iterator = (function () {
    function Iterator(parent) {
      ...
      var subscription = function subscription(data, message) {
        var context = contexts.get(_this2),
  ...
  var ChannelBase = (function () {
    ...
    _createClass(ChannelBase, [{
          ...
          (function () {
            ...
            subscriptions.forEach(function (subscription) {
              try {
                ...
                results.push(error);
                bus.getOne(CHANNEL_NAME_ERROR).publish(new Message(message, error), function (errorResults) {
      ...
      key: 'subscribers',
      get: function get() {
        return contexts.get(this).subscriptions.map(function (subscription) {
  ...
  var MessageBase = (function () {
    function MessageBase() {
      ...
      if (isSomething(origin)) defineProperty(this, 'origin', {
        value: origin,
        enumerable: true
      });
    }
  ...
  var SectionBase = (function () {
    ...
    _createClass(SectionBase, [{
      ...
      key: 'unsubscribe',
      value: function unsubscribe() {
        for (var _len6 = arguments.length, subscriptions = Array(_len6), _key6 = 0; _key6 < _len6; _key6++) {
          subscriptions[_key6] = arguments[_key6];
        }
  ...
  function aerobus() {
    ...
    function unsubscribe() {
      for (var _len9 = arguments.length, subscriptions = Array(_len9), _key9 = 0; _key9 < _len9; _key9++) {
        subscriptions[_key9] = arguments[_key9];
      }
