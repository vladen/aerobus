    ...
    _createClass(ChannelGear, [{
      ...
      value: function iterate() {
        ...
        return new Iterator(function (observer) {
          return _this4.observe(observer);
        });
      }
    }, {
      key: 'propagate',
      ...
      value: function observe(observer) {
        ...
        return function () {
          var observers = _this5.observers,
        ...
        if (retentions) retentions.forEach(function (message) {
          return subscriptions.forEach(function (subscription) {
            try {
              ...
              _this8.bus.get(CHANNEL_NAME_ERROR).publish(message.fail(error));
            }
          });
        });
      }
    ...
    _createClass(SectionGear, [{
      ...
      value: function forEach(callback) {
        this.channels.forEach(function (channel) {
          return callback(getGear(channel));
        });
      }
    }, {
      key: 'iterate',
      value: function iterate() {
        ...
        return new Iterator(function (observer) {
          var disposers = _this12.channels.map(function (channel) {
