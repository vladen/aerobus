...
(function (global, factory) {
  ...
  describe('Aerobus', function () {
    ...
    describe('#create()', function () {
      ...
      it('new Aerobus inherits Channel class extensions', function () {
        var extension = function extension() {};
      ...
      it('new Aerobus inherits Message class extensions', function () {
        var extension = function extension() {},
            result = undefined,
            subscriber = function subscriber(_, message) {
          return result = message;
      ...
      it('new Aerobus inherits Section class extensions', function () {
        var extension = function extension() {};
    ...
    describe('#trace', function () {
      ...
      it('is called from channel.subscribe(@function) with arguments ("subscribe", channel, array) where array contains Subscriber wrapping @function', function () {
