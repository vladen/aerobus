...
(function (global, factory) {
  ...
  describe('aerobus(@object)', function () {
    ...
    describe('returned Aerobus#delimiter', function () {
      it('gets @object.delimiter', function () {
        var delimiter = ':',
            bus = aerobus({
          delimiter: delimiter
        });
    ...
    describe('returned Aerobus~Aerobus.Channel instances', function () {
      it('extended with @object.channel members', function () {
      ...
      it('preserve standard api members', function () {
        var extensions = {
          clear: null,
          disable: null,
          enable: null,
    ...
    describe('returned Aerobus~Aerobus.Message instances', function () {
      it('extended with @object.message members', function () {
        var extension = function extension() {},
            bus = aerobus({
          message: {
            extension: extension
    ...
    describe('returned Aerobus~Aerobus.Section instances', function () {
      it('extended with @object.section members', function () {
        var extension = function extension() {},
            bus = aerobus({
          section: {
            extension: extension
