...
(function (global, factory) {
  ...
  describe('aerobus(@object)', function () {
    ...
    it('Aerobus.Channel api is extended with @object.channel members', function () {
    ...
    it('Aerobus.Channel standard api is not shadowed by @object.channel members', function () {
      var extensions = {
        clear: null,
        disable: null,
        enable: null,
    ...
    it('Aerobus.Message api extended with @object.message members', function () {
      var extension = function extension() {},
          bus = aerobus({
        message: {
          extension: extension
    ...
    it('Aerobus.Message standard api is not shadowed by @object.message members', function () {
      var extensions = {
        channel: null,
        data: null
      },
    ...
    it('Aerobus.Section api is extended with @object.section members', function () {
      var extension = function extension() {},
          bus = aerobus({
        section: {
          extension: extension
