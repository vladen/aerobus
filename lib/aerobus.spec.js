...
(function (global, factory) {
  ...
  describe('Aerobus.Section', function () {
    ...
    describe('#clear()', function () {
      ...
      it('clears #channels[...].subscribers', function () {
        var section = aerobus()('test1', 'test2'),
            subscriber = function subscriber() {};
    ...
    describe('#enable()', function () {
      ...
      it('sets #channels[...].enabled', function () {
        var section = aerobus()('test1', 'test2');
    ...
    describe('#enable(false)', function () {
      it('clears #channels[...].enabled', function () {
        var section = aerobus()('test1', 'test2');
    ...
    describe('#publish(@object)', function () {
      it('publishes @object to all #channels in order of declaration', function () {
        var section = aerobus()('test1', 'test2'),
            publication = {},
            results = [],
            subscriber = function subscriber(_, message) {
    ...
    describe('#subscribe(@function)', function () {
      ...
      it('subscribes @function to all #channels', function () {
        var section = aerobus()('test1', 'test2'),
            subscriber = function subscriber() {};
    ...
    describe('#toggle()', function () {
      ...
      it('clears #channels[...].enabled for enabled channels', function () {
        var section = aerobus()('test1', 'test2');
      ...
      it('sets #channels[...].enabled for disabled channels', function () {
        var section = aerobus()('test1', 'test2');
    ...
    describe('#unsubscribe(@function)', function () {
      it('unsubscribes @function from all #channels', function () {
        var section = aerobus()('test1', 'test2'),
            subscriber = function subscriber() {};
