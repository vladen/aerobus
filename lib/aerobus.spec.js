...
(function (global, factory) {
  ...
  describe('Aerobus.Channel', function () {
    ...
    describe('#subscribe(@function)', function () {
      ...
      it('adds new subscriber to #subscribers, Subscriber#next returns @function', function () {
        var channel = aerobus().root,
            subscriber = function subscriber() {};
  ...
  describe('Aerobus.Iterator', function () {
    ...
    describe('#next().value', function () {
      ...
      it('is pending promise by default', function (done) {
        var pending = {},
            result = undefined,
      ...
      it('resolves with message published earlier', function (done) {
        var data = {},
            result = undefined,
            channel = aerobus().root,
      ...
      it('ignores channel strategies', function (done) {
        var result = 0,
            channel = aerobus().root;
        channel.cycle(1);
  ...
  describe('Aerobus.Message', function () {
    ...
    describe('#skip', function () {
      it('skips subsequent subscribers when returned from subscriber', function () {
        var results = 0,
      ...
      it('skips subsequent subscribers when returned from subscriber of parent channel', function () {
