...
(function (global, factory) {
  ...
  describe('aerobus()', function () {
    ...
    describe('.trace', function () {
      ...
      it('is invoked for channel.unsubscribe with arguments ("unsubscribe", channel, subscribers)', function () {
        var _bus$root2;
  ...
  describe('Aerobus.Message', function () {
    ...
    describe('.prior', function () {
      it('gets prior message delivered to previous channel in publication chain', function () {
        var bus = aerobus(),
            channel = bus('test'),
            prior = undefined,
            result = undefined,
