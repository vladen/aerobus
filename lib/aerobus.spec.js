...
(function (global, factory) {
  ...
  describe('aerobus(@function)', function () {
    ...
    describe('returned Aerobus#trace', function () {
  ...
  describe('aerobus(@string)', function () {
    ...
    describe('returned Aerobus#delimiter', function () {
  ...
  describe('aerobus(@object)', function () {
    ...
    describe('returned Aerobus~Aerobus.Channel instances created by this bus', function () {
    ...
    describe('returned Aerobus~Aerobus.Message instances', function () {
      ...
      it('preserve standard api', function () {
        var extensions = {
          destination: null,
          data: null,
          route: null
    ...
    describe('returned Aerobus~Aerobus.Section instances', function () {
  ...
  describe('Aerobus', function () {
    ...
    describe('#("error")', function () {
      ...
      it('returns #error channel', function () {
        var bus = aerobus(),
            channel = bus('error');
        assert.strictEqual(channel, bus.error);
      });
      it('returned Aerobus.Channel#name gets "error"', function () {
        var bus = aerobus(),
            name = 'error';
        assert.strictEqual(bus(name).name, name);
      });
    ...
    describe('#(@array|@boolean|@date|@number|@object)', function () {
      it('throws', function () {
        assert.throw(function () {
          return aerobus()([]);
        });
    ...
    describe('#channels', function () {
      ...
      it('exposes error channel', function () {
        var bus = aerobus(),
            channel = bus.error;
        assert.include(bus.channels, channel);
      });
      it('exposes root channel', function () {
        var bus = aerobus(),
            channel = bus.root;
        assert.include(bus.channels, channel);
      });
      it('exposes custom channel', function () {
        var bus = aerobus(),
            channel = bus('test');
        assert.include(bus.channels, channel);
      });
      it('exposes several channels', function () {
        var bus = aerobus(),
            channel0 = bus.root,
            channel1 = bus.error,
            channel2 = bus('test');
    ...
    describe('#clear()', function () {
      ...
      it('Aerobus.Channel#isDeleted returns true for every deleted channel', function () {
        var bus = aerobus(),
            channel0 = bus.root,
            channel1 = bus.error,
            channel2 = bus('test');
      ...
      it('getting channel with same Aerobus.Channel#name resolves new channel', function () {
        var bus = aerobus(),
            channel0 = bus.root,
            channel1 = bus.error,
            channel2 = bus('test');
    ...
    describe('#create()', function () {
      ...
      it('returned Aerobus inherits #delimiter', function () {
        var delimiter = ':';
        assert.strictEqual(aerobus(delimiter).create().delimiter, delimiter);
      });
      it('returned Aerobus inherits ~Aerobus.Channel extension', function () {
        var extension = function extension() {};
      ...
      it('returned Aerobus inherits ~Aerobus.Message extension', function () {
        var extension = function extension() {},
            result = undefined,
      ...
      it('returned Aerobus inherits ~Aerobus.Section extension', function () {
        var extension = function extension() {};
      ...
      it('returned Aerobus inherits #trace', function () {
        var trace = function trace() {};
    ...
    describe('#delete()', function () {
      ...
      it('deletes bus (setting #isDeleted)', function () {
        var bus = aerobus();
        assert.isTrue(bus.delete().isDeleted);
      });
      it('attempt to use deleted bus throws', function () {
    ...
    describe('#isDeleted', function () {
      ...
      it('is true after bus has been deleted', function () {
        var bus = aerobus().delete();
    ...
    describe('#trace', function () {
      ...
      it('is invoked for channel.disable with arguments ("disable", channel)', function () {
        var results = [],
            trace = function trace() {
      ...
      it('is invoked for channel.enable with arguments ("enable", channel)', function () {
        var results = [],
            trace = function trace() {
      ...
      it('is invoked for channel.publish with arguments ("publish", channel, message)', function () {
        var data = {},
            results = [],
            trace = function trace() {
      ...
      it('is invoked for channel.retain with arguments ("retain", channel, limit)', function () {
        var limit = 42,
            results = [],
            trace = function trace() {
      ...
      it('is invoked for channel.subscribe with arguments ("subscribe", channel, parameters)', function () {
        var _bus$root;
      ...
      it('is invoked for channel.parameters with arguments ("unsubscribe", channel, parameters)', function () {
        var _bus$root2;
    ...
    describe('#unsubscribe()', function () {
      ...
      it('clears .subscribers of all channel', function () {
        var bus = aerobus(),
            channel0 = bus.root,
            channel1 = bus('test1'),
            channel2 = bus('test2'),
  ...
  describe('Aerobus.Channel', function () {
    ...
    describe('#delete()', function () {
      ...
      it('deletes channel (setting #isDeleted)', function () {
        assert.isTrue(aerobus().root.delete().isDeleted);
      });
      it('attempt to use deleted channel throws', function () {
    ...
    describe('#isDeleted', function () {
      ...
      it('is true after channel has been deleted', function () {
        var channel = aerobus().root.delete();
    ...
    describe('#unsubscribe(@string)', function () {
      it('removes all subscriptions with name equal to @string from .subscribers', function () {
        var channel = aerobus().root,
            name = 'test',
            subscriber0 = function subscriber0() {},
            subscriber1 = function subscriber1() {};
