...
(function (global, factory) {
  ...
  describe('Aerobus', function () {
    ...
    describe('#trace', function () {
      ...
      it('is called from channel.cycle() with arguments ("cycle", channel, @object) where @object is instance of Aerobus.Strategy.Cycle', function () {
        var results = [],
            trace = function trace() {
      ...
      it('is called from channel.cycle(2) with arguments ("cycle", channel, @object) where @object.limit is 2 and @object.step is 2', function () {
        var results = [],
            trace = function trace() {
      ...
      it('is called from channel.cycle(2, 1) with arguments ("cycle", channel, @object) where @object.limit is 2 and @object.step is 1', function () {
        var results = [],
            trace = function trace() {
      ...
      it('is called from channel.publish(@data) with arguments ("publish", channel, message) where message.data is @data', function () {
        var data = {},
            results = [],
            trace = function trace() {
      ...
      it('is called from channel.shuffle() with arguments ("shuffle", channel, @object) where @object is instance of Aerobus.Strategy.Shuffle', function () {
        var results = [],
            trace = function trace() {
      ...
      it('is called from channel.shuffle(2) with arguments ("shuffle", channel, @object) where @object.limit is 2', function () {
        var results = [],
            trace = function trace() {
  ...
  describe('Aerobus.Channel', function () {
    ...
    describe('#shuffle()', function () {
      ...
      it('makes channel to deliver publication randomly', function () {
        var result0 = 0,
            result1 = 0,
            subscriber0 = function subscriber0() {
          return ++result0;
    ...
    describe('#shuffle(2)', function () {
      it('makes channel to deliver publication randomly to pair of subscribers at once', function () {
        var result0 = 0,
            result1 = 0,
            subscriber0 = function subscriber0() {
          return ++result0;
