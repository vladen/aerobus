...
(function (global, factory) {
	...
	describe('aerobus', () => {
		...
		it('extend should work with Channel', () => {
			let bus = _aerobus2.default.extend('Channel', {
				newMethod: () => 'test'
			})(delimiter, trace);
		...
		it('extend should work with Section', () => {
			let bus = _aerobus2.default.extend('Section', {
				newField: 'test'
			})(delimiter, trace);
		...
		it('extend should work independently', () => {
			let extendAerobus = _aerobus2.default.extend('Channel', {
				newField: 'test'
			});
		...
		it('extend should work chainly', () => {
			let aerobus1 = _aerobus2.default.extend('Channel', {
				newMethod: () => 'test'
			});
