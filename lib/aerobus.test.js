...
(function (global, factory) {
  ...
  describe('aerobus:', function () {
    ...
    describe('return value:', function () {
      ...
      describe('channels property:', function () {
        ...
        it('should return new instance (clone) each time', function () {
          var bus = (0, _aerobus2.default)();
        ...
        it('should contain one custom channel after its resolution', function () {
          var bus = (0, _aerobus2.default)(),
              channel = bus('test');

          _chai.assert.include(bus.channels, channel);
        });
        it('should contain many custom channels after their resolution', function () {
          var bus = (0, _aerobus2.default)(),
              channel1 = bus('test1'),
              channel2 = bus('test2');
  ...
  describe('Channel class:', function () {
    ...
    describe('publish method:', function () {
      ...
      it('should notify one subscriber with provided data', function (done) {
        var data = {};
      ...
      it('should notify many subscribers with provided data', function (done) {
        var count = 0,
            data = {};
        (0, _aerobus2.default)().root.subscribe(function (value) {
          _chai.assert.strictEqual(value, data);
    ...
    describe('subscribers property:', function () {
      ...
      it('should return new instance (clone) each time', function () {
        ...
        _chai.assert.notStrictEqual(channel.subscribers, channel.subscribers);
      });
    });
